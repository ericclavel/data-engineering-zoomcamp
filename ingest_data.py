...
@click.option('--target_table', default='yellow_taxi_data', help='Target table name in database')
@click.option('--chunksize', default=100000, type=int, help='Chunk size for reading CSV')
@click.option('--url', default=None, help='URL to CSV file (if not provided, will be constructed from year/month)')
def run(pg_user, pg_password, pg_host, pg_port, pg_db, year, month, target_table, chunksize, url):
    """Ingest taxi data into PostgreSQL database."""
